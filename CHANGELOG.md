...
### Changed
- New icon design
- Screenshot repertory
- Improved snapcraft.yaml
- Flatpak development script runs test instance

### Fixed
- Snapcraft issues with arquitectures
- Icon not being properly picked up due to missing app id
